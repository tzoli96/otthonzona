  ...
  return (
      <div>
        <div className="flex !flex-row">
          ...
          <div className="w-1/5 hidden lg:block py-1 pr-2 my-1">{history.paymentTransactionId}</div>
        ...
        <div
            ...
            ref={gridRef}
        >
          <div className="flex !items-start font-bold py-1 pr-2 my-1 col-span-5">Tranzakció azonosító</div>
          <div className="flex !items-start py-1 pr-2 my-1 col-span-7">{history.paymentTransactionId}</div>

          <div className="flex !items-start font-bold py-1 pr-2 my-1 col-span-5">Vásárolt kredit</div>
          <div className="flex !items-start py-1 pr-2 my-1 col-span-7">{thousandSeparator(history.purchasedCredit)}</div>

          <div className="flex !items-start font-bold py-1 pr-2 my-1 col-span-5">Elköltött összeg</div>
          <div className="flex !items-start py-1 pr-2 my-1 col-span-7">{thousandSeparator(history.spentMoney)} Ft</div>
