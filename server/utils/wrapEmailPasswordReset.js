function wrapEmail({ content, title }) {
  return `
    ...
    <html lang="en">
      ...
      <head></head>
      <div id="__react-email-preview" style="display:none;overflow:hidden;line-height:1px;opacity:0;max-height:0;max-width:0">Jelszó helyreállíása<div></div>
      </div>
        ...
        <table align="center" role="presentation" cellSpacing="0" cellPadding="0" border="0" width="100%" style="max-width:600px;margin:0 auto">
          <tr style="width:100%">
            <td>
              ...
              <h1 style="color:#1d1c1d;font-size:36px;font-weight:700;margin:30px 0;padding:0;line-height:42px">Jelszó helyreállítása</h1>
              <p style="font-size:20px;line-height:28px;margin:16px 0;margin-bottom:30px">Kedves felhasználó, az alábbi linkre kattintva tudod megváltoztatni jelszavadat.</p>
